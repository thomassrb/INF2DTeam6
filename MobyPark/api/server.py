    ...
    def __init__(self, *args, **kwargs):
        ...
        self.routes = {
            'POST': {
                ...
                '/parking-lots': lambda: post_routes._handle_create_parking_lot(self), # load_tester CHECK!
                '/reservations': lambda: post_routes._handle_create_reservation(self), # FAILED!!!!
                '/vehicles': lambda: post_routes._handle_create_vehicle(self),
                '/payments': lambda: post_routes._handle_create_payment(self),
                re.compile(r'^/parking-lots/([^/]+)/sessions/start$'): lambda: post_routes._handle_start_session(self),
                re.compile(r'^/parking-lots/([^/]+)/sessions/stop$'): lambda: post_routes._handle_stop_session(self),
                '/payments/refund': lambda: post_routes._handle_refund_payment(self),
            ...
            'GET': {
                ...
                '/index': lambda: get_routes._handle_index(self),
                ...
                '/vehicles':lambda: get_routes._handle_get_vehicles(self),
                '/parking-lots/':lambda: get_routes._handle_get_parking_lot_details(self),
                '/reservations/':lambda: get_routes._handle_get_reservation_details(self),
                '/payments/': lambda: get_routes._handle_get_payment_details(self),
                '/billing/': lambda: get_routes._handle_get_user_billing(self),
                '/vehicles/': lambda: get_routes._handle_get_vehicle_details(self),
                '/vehicles/reservations': lambda: get_routes._handle_get_vehicle_reservations(self),
                '/vehicles/history': lambda: get_routes._handle_get_vehicle_history(self),
                '/parking-lots/sessions': lambda: get_routes._handle_get_parking_lot_sessions(self),
